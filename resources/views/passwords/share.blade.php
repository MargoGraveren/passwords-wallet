        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header">{{ __('Share Password With Other User')}}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('share.store')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="web_address" type="hidden" class="form-control" name="web_address"
                                           value="{{ $password->web_address }}">
                                </div>
                                <div class="col-md-6">
                                    <input id="login" type="hidden" class="form-control" name="login"
